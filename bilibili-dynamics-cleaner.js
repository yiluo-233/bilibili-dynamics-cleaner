...
(() => {
  ...
  function mount() {
    ...
    style.textContent = `
      ...
      #blrc-launcher.is-active::after{content:"";position:absolute;right:-3px;top:-3px;width:6px;height:6px;border-radius:50%;background:#f5222d;box-shadow:0 1px 4px #0004}
